...
declare var google;
@Component({
  selector: 'app-comisareat',
  templateUrl: './comisareat.page.html',
  styleUrls: ['./comisareat.page.scss'],
})


export class ComisareatPage implements OnInit {
  ...
  constructor(private geolocation:Geolocation,
    ...
    private comusService:ComusareatService,private route:ActivatedRoute,private router:Router,private rout:NavController) {
